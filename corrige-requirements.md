...
> [!TIP]
> 1. Acessar o arquivo env\Lib\\site-packages\lazypredict\Supervised.py
...
class LazyClassifier:
    ...
    >>> models
    | Model                          |   Accuracy |   Balanced Accuracy |   ROC AUC |   F1 Score | Tempo levado |
    |:-------------------------------|-----------:|--------------------:|----------:|-----------:|-------------:|
...
class LazyRegressor:
    ...
    >>> models
    | Model                         | R-Quadrado Ajustado | R-Quadrado |  RMSE |Tempo levado|
    |:------------------------------|-------------------:|----------:|------:|-----------:|
    ...
    def fit(self, X_train, X_test, y_train, y_test):
            ...
            try:
                ...
                if self.verbose > 0:
                    scores_verbose = {
                        ...
                        "R-Quadrado Ajustado": adj_rsquared,
                        "RMSE": rmse,
                        "Tempo levado": time.time() - start,
                    }
        ...
        scores = scores.sort_values(by="R-Quadrado Ajustado", ascending=False).set_index(
            "Model"
        )
