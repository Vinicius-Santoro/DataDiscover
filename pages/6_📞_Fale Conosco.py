...
profile_image_file_path1 = "C:/Users/vinic/OneDrive/Área de Trabalho/Workspace/Projetos e Estudos/Projetos/Projetos_Gerais/Fatec/DataDiscover/images/vinicius.jpg"
...
profile_image_file_path2 = "C:/Users/vinic/OneDrive/Área de Trabalho/Workspace/Projetos e Estudos/Projetos/Projetos_Gerais/Fatec/DataDiscover/images/henrique.jpg"
...
<div style="display: flex; justify-content: center;">
    <div style="flex-grow: 1; margin-right: 20px; text-align: center;">
        ...
        <p style="text-align: left;">- 🎯 Responsável por garantir uma experiência excelente dos clientes utilizando assistente virtual no aplicativo Itaú.<p>
        <p style="text-align: left;">- 🤖 You can check my projects on Medium: Guilherme Datt</p>
        <p style="text-align: left;">- 🏂 Love studying, reading, and training</p>
    ...
    <div style="flex-grow: 1; margin-left: 20px; text-align: center;">
        <img src="{}" alt="Your Name" width="200" height="200" style="border-radius: 50%; object-fit: cover; margin-top: 40px; margin-bottom: 40px;">
        <h4><i>{}</i></h4>
        <p style="text-align: left;">- 🧑‍💻 Engenheiro de Dados, trabalhando com Python, Pyspark, Terraform e Glue.</p>
        <p style="text-align: left;">- 📝 Cursando o quarto semestre de ciência de dados na FATEC.</p>
        <p style="text-align: left;">- ❤️ Responsável por garantir uma experiência excelente dos clientes utilizando assistente virtual no aplicativo Itaú..</p>
        <p style="text-align: left;">- 📝 You can find some of my projects on GitHub: username</p>
        <p style="text-align: left;">- 🏂 In my free time, I enjoy hiking, cooking, and playing guitar</p>
        <p style="text-align: left;">- 📧 Feel free to contact me at: email@example.com</p>
        <p style="text-align: left;">- 🏠 Based in New York City</p>
    </div>
</div>
